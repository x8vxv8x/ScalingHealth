...
public class ModifierHandler {
    ...
    public static final String MODIFIER_NAME_HEALTH = Tags.MOD_ID + ".HealthModifier";
    public static final String MODIFIER_NAME_DAMAGE = Tags.MOD_ID + ".DamageModifier";
    ...
    public static void setMaxHealth(EntityLivingBase entity, double amount, int op) {
        ...
        if (entity instanceof EntityPlayer && !Config.Player.Health.allowModify) {
            ...
            ScalingHealth.LOGGER.info(String.format(
